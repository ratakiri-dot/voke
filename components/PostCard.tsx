          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center space-x-2">
                <h4 className="font-extrabold text-slate-800 leading-none text-lg">{author.name}</h4>
                {isCurrentlyPromoted && (
                  <span className="bg-indigo-600 text-white text-[8px] font-black px-2.5 py-1 rounded-full uppercase tracking-widest shadow-lg shadow-indigo-100">
                    <i className="fas fa-sparkles mr-1"></i> Spotlight
                  </span>
                )}
              </div>
